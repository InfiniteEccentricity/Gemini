...
parser.add_argument("--local_epochs", type=int, default=None, help="Number of local training epochs (overrides local_steps if set)")
parser.add_argument("--batch_size", type=int, default=30)
parser.add_argument("--test_bsz", type=int, default=128)
parser.add_argument("--backend", type=str, default="gloo")
parser.add_argument("--learning_rate", type=float, default=5e-2, help="Client learning rate")
parser.add_argument("--client_momentum", type=float, default=0.0, help="Client-side momentum")
parser.add_argument("--server_learning_rate", type=float, default=1.0, help="Server learning rate for FedBuff aggregation")
parser.add_argument("--server_momentum", type=float, default=0.0, help="Server-side momentum for aggregation")
parser.add_argument("--use_lr_norm", type=bool, default=False, help="Use Learning Rate Normalization for clients")
